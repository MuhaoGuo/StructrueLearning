...
num_nodes = 1000
num_samples = 5000
generate_data_sparse(num_nodes, num_samples, density=0.01, num_cases=1)
...
def one_time(data_id, seed =1):
    ...
    best_rho2 = 10 ** -0.3  # todo density =0.2, node=10， num_samples =1000，  100%  越小，结果越稠密
    best_rho2 = 10 ** -0.5  # todo density =0.01, node=100， num_samples =1000 几乎100%
    best_rho2 = 10 ** -1  # todo density =0.01, node=1000  num_samples =5000

    precision_, history = covsel_S(S=cov_matrix, lambda_val=0.0001, rho=0.00001, alpha=1)#num_nodes = 1000, num_samples = 5000, dentsity 0.01
